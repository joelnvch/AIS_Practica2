...
class SystemTest {
	...
	public void setupTest() {
		...
		playJ1.click();
		playJ2.click();
		//Se espera unos 20 segundos máximo antes de pasar a la página del tablero en caso de que la conexión sea lenta
	...
	private void esperarCuadrosDeDialogo() {
		//Se espera hasta un minuto en ambas conexiones en caso de que la conexión sea lenta
